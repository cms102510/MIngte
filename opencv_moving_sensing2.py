...
while True:
    ...
    if diff_cnt > diff_max:
        ...
        if on_record == False:
            video = cv2.VideoWriter("Minsu's 웹캠 " + nowDatetime_path + ".avi", fourcc, 1, (frame_c.shape[1], frame_c.shape[0]))
    ...
    draw.text(xy=(10, 15),  text="Minsu's 웹캠 "+nowDatetime, font=font, fill=(255, 255, 255))
